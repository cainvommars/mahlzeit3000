...
~~~sh
git clone git@github.com:nko3/backensolo.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-backensolo --password z71wELHQskDg5eEb
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/backensolo" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280821
[3]: https://github.com/nko3/backensolo
